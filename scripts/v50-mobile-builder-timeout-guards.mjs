...
assert(guidanceSurface.includes("call add_question exactly once for the first question") && guidanceSurface.includes("after every later accepted add_question call open_quiz again"), "one-at-a-time refresh builder guidance missing");
...
assert(remote.includes("alternate add_question and open_quiz once per question"), "start_quiz next-step missing per-question open_quiz guidance");
