...
assert(remote.includes("v23SyncLaunchedDraft") && remote.includes("first accepted add_question launches the widget"), "staged authoring must launch from the first accepted add_question");
