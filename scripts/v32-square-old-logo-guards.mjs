...
for (const file of [
  ...
  // Square app icon requirement: no baked rounded/circular transparent corners.
...
if (failures.length) {
  console.error("V32 square old-logo guards failed:");
  for (const failure of failures) console.error(" - " + failure);
  process.exit(1);
}

console.log("V32 square old-logo guards passed.");
