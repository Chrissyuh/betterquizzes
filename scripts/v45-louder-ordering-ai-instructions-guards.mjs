...
assert(remote.includes("For ordering: type=ordering, use items and orderingBehavior.direction=top_to_bottom; answer item ids are optional"), "add_question description missing ordering checklist");
...
assert(remote.includes("use items and orderingBehavior.direction") && remote.includes("answer item ids are optional"), "ordering shape checklist missing");
