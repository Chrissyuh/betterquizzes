...
assertIncludes("dist/assets/index-XinejuK9.js", "requestChatGptGradeOnce", "compiled automatic grade handoff function");
...
console.log("Stage 12.7.0 regression checks passed.");
...
assertIncludes("dist/assets/index-XinejuK9.js", "betterquizzer.answer_state", "compiled answer persistence");
assertExcludes("dist/assets/index-XinejuK9.js", "Your order is submitted from top to bottom.", "compiled removed ordering copy");
...
console.log("Stage 12.7.0 publish-candidate checks passed.");
process.exit(0);
