...
4. Generate valid question data. multiple_choice and multi_select require a non-empty choices array. matching requires canonical left:[{id,text}], right:[{id,text}], and answer:[{leftId,rightId}]. Do not author matching as pairs unless repairing legacy input. ordering requires an items array. If unsure, use fill_blank, short_answer, or long_response instead of inventing an invalid structure.
