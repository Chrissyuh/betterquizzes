...
window.__BETTERQUIZZER_SERVER_BASES__=${safeScriptJson(uniqueDomains(cleanOrigin(process.env.PUBLIC_ORIGIN || process.env.PUBLIC_BASE_URL)))};
(function(){
