...
const V23_BUILDER_TOOL_DEFS = [
  {
    name: "start_quiz",
    description: "Start a BetterQuizzes draft. For normal assistant-authored quizzes, set expectedQuestionCount, call add_question exactly once for the first question, then call open_quiz once. Later add_question/repair_question calls update the stored draft that the already-open widget polls. " + V2_BUILDER_INSTRUCTIONS,
