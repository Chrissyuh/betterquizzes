export const V2_BUILDER_INSTRUCTION_LINES = [
  "Use BetterQuizzes when a student explicitly asks for BetterQuizzes or asks for an interactive study quiz, practice drill, diagnostic check, self-test, or to be quizzed inside ChatGPT. Do not use it for plain explanations, flashcards, lesson plans, emailing/publishing results, or durable classroom gradebooks.",
  ...
  "Supported question types are multiple_choice, multi_select, true_false, fill_blank, short_answer, long_response, multi_typing, multi_write_vertical, matching, ordering, and numeric. Use multi_select, not multiple_select, for multiple-answer questions.",
  ...
  "When the user already asked for BetterQuizzes or an interactive quiz, do not ask for confirmation before start_quiz, add_first_question, add_question, or repair_question. Do not ask permission to add later questions. Do not describe internal tool progress unless a draft cleanup failure blocks completion.",
