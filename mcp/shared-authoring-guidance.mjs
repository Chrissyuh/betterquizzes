export const V2_BUILDER_INSTRUCTION_LINES = [
  ...
  "For normal assistant-authored quizzes, build quietly. Do not send chat progress/check-in messages while authoring. Start with start_quiz and expectedQuestionCount, call add_question or repair_question once per question until the expected count is reached, then call finalize_quiz once to launch the widget with the complete stored draft. Do not call open_quiz for new assistant-authored quizzes. Do not send question batches in start_quiz.",
